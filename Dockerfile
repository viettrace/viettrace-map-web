...
ARG NEXT_PUBLIC_TILE_URL_ISLANDS=http://localhost:8080/tiles/vn_offshore_islands
ARG NEXT_PUBLIC_MAP_STYLE=https://basemaps.cartocdn.com/gl/positron-gl-style/style.json
ARG NEXT_PUBLIC_TILE_CACHE_BUSTER=
...
ENV NEXT_PUBLIC_TILE_URL_ISLANDS=$NEXT_PUBLIC_TILE_URL_ISLANDS
ENV NEXT_PUBLIC_MAP_STYLE=$NEXT_PUBLIC_MAP_STYLE
ENV NEXT_PUBLIC_TILE_CACHE_BUSTER=$NEXT_PUBLIC_TILE_CACHE_BUSTER
