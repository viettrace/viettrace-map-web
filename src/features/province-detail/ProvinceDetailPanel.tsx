...
export default function ProvinceDetailPanel({ entry, onClose }: ProvinceDetailPanelProps) {
  ...
  return (
    <aside className="absolute right-3 bottom-8 left-3 z-20 max-h-[44dvh] overflow-y-auto rounded-lg border border-slate-200 bg-white/95 text-sm text-slate-700 shadow-xl backdrop-blur-sm md:top-24 md:right-4 md:bottom-auto md:left-auto md:max-h-[calc(100dvh-8rem)] md:w-96">
