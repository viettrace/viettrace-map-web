  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="pointer-events-auto absolute top-1/2 left-1/2 flex h-12 w-12 -translate-x-1/2 -translate-y-1/2 cursor-ew-resize items-center justify-center rounded-full border border-slate-200 bg-white text-slate-700 shadow-lg focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:outline-none"
